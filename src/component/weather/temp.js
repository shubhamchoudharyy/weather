...
const Temp = () => {
    ...
    const getWeatherInfo=async ()=>{
        try{
            let url=`https://api.openweathermap.org/data/2.5/weather?q=${searchValue}&units=metric&appid=fb4935ea5204e5e1979f037d2fff72c7`;
            ...
            // console.log(temp);
            setSearchValue(myNewWeatherInfo);
